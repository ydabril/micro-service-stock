package com.emazon.msstock.infraestructure.configuration.security;

import com.emazon.msstock.infraestructure.configuration.jwt.JwtAuthEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> {
                    auth.antMatchers("/auth/login", "/article/all", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/img/**", "/article/images/**").permitAll();
